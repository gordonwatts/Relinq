  ...
  public abstract class ExtensionExpression : Expression
  {
        ...
        : base (nodeType, ArgumentUtility.CheckNotNull ("", type))
    {
      ArgumentUtility.CheckNotNull ("type", type);
        ...
        /// <summary>
        /// Must be overridden by <see cref="ExtensionExpression"/> subclasses by calling the Visit(Expression) method of <see cref="ExpressionVisitor"/> on all 
    ...
    public Expression ReduceAndCheck ()
    {
      ...
      return result;
        ...
        /// <summary>
        /// Accepts the specified visitor, by default dispatching to VisitExtension of <see cref="ExpressionVisitor"/>. 
        ...
        /// the base implementation of <see cref="Accept"/>, which will dispatch to VisitExension of <see cref="ExpressionVisitor"/>.
        /// </remarks>
